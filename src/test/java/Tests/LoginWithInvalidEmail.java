...
public class LoginWithInvalidEmail {
    ...
    public static void main(String[] args) {
        ...
        // Enter an invalid email and password, then submit the login form
        ...
        Assert.assertEquals(errorMessage.getText(), "The email field must be a valid email address.", "Error message text does not match!");
