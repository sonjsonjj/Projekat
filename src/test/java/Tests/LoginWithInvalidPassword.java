...
public class LoginWithInvalidPassword {
    ...
    public static void main(String[] args) {
        ...
        // Enter a valid email but invalid password, then submit the login form
        emailField.sendKeys("sonjaaa.kesic96@gmail.com");
        passwordField.sendKeys("wrongpassword");
        signInButton.click();

        // Wait for the error message to be visible (for invalid password)
        ...
        Assert.assertEquals(errorMessage.getText(), "The email address or password you entered is invalid", "Error message text does not match!");
